...
class HalfedgeMesh {
 public:
  ...
  EdgeIter addEdge(HalfedgeIter e0, HalfedgeIter e1);
  void collapsehelper(HalfedgeIter h);
  VertexIter addVertexOnEdge(EdgeIter e);
  vector<HalfedgeIter> findHalfedge(FaceIter f, vector<VertexIter> vs);
  bool need_erase(HalfedgeIter h);
